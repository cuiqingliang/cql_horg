...
:py:func:`platform1.linux_distribution` function, but it provides much more
functionality. An alternative implementation became necessary because Python
3.5 deprecated this function, and Python 3.8 will remove it altogether.
Its predecessor function :py:func:`platform1.dist` was already
...
def linux_distribution(full_distribution_name=True):
    ...
    * ``codename``:  The result of :func:`distro.codename`.
    ...
    :py:func:`platform1.linux_distribution` function, supporting a subset of
    its parameters.
...
class LinuxDistribution(object):
    ...
    def linux_distribution(self, full_distribution_name=True):
        ...
        with Python's :func:`platform1.linux_distribution`, supporting a subset
        of its parameters.
