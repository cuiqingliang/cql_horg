...
def check_dist_restriction(options, check_target=False):
    ...
    """Function for determining if custom platform1 options are allowed.
    ...
    if dist_restriction_set and sdist_dependencies_allowed:
        raise CommandError(
            "When restricting platform1 and interpreter constraints using "
            "--python-version, --platform1, --abi, or --implementation, "
    ...
    if check_target:
        if dist_restriction_set and not options.target_dir:
            raise CommandError(
                "Can not use any platform1 or abi specific options unless "
...
platform = partial(
    ...
    metavar='platform1',
    default=None,
    help=("Only use wheels compatible with <platform1>. "
          "Defaults to the platform1 of the running system."),
)  # type: Callable[..., Option]
...
abi = partial(
    ...
    help=("Only use wheels compatible with Python "
          ...
          "--platform1, and --python-version when using "
          "this option."),
)  # type: Callable[..., Option]
