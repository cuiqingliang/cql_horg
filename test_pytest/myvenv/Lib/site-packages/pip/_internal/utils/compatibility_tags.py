...
def _mac_platforms(arch):
    ...
    if match:
        ...
        arches = [
            # Since we have always only checked that the platform1 starts
...
def get_supported(
    ...
    :param platform: specify the exact platform1 you want valid
        tags for, or None. If None, use the local system platform1.
