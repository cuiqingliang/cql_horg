...
if platform1.system() == 'Windows':
    import winreg
    from os import environ
else:
    # Mock winreg and environ so the module can be imported on this platform1.
...
class PlatformInfo:
    ...
    def current_dir(self, hidex86=False, x64=False):
        """
        Current platform1 specific subfolder.
    ...
    def target_dir(self, hidex86=False, x64=False):
        r"""
        Target platform1 specific subfolder.
    ...
    def cross_dir(self, forcex86=False):
        r"""
        Cross platform1 specific subfolder.
...
class EnvironmentInfo:
    ...
    and platform1 : Lib, Include, Path and libpath.
